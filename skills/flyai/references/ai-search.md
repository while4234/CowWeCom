...
```powershell
python skills\flyai\scripts\flyai_wrapper.py ai-search --query "五一去杭州玩三天，预算人均2000，想住西湖附近，推荐行程和酒店"
python skills\flyai\scripts\flyai_wrapper.py ai-search --query "下周从上海去东京，优先直飞，帮我找性价比高的航班和酒店"
```
