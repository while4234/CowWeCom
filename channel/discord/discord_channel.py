            ...
            self.app_commands.Command(
                ...
                callback=self._with_grok_choices(
                    self.app_commands.describe(
                        ...
                        color_tone="Color tone key, \u968f\u673a, or custom:<prompt>; blank means no color tone",
                        nationality="Material key or custom:<prompt>",
                        pose="Material key or custom:<prompt>",
                        action="Material key or custom:<prompt>",
                        clothing="Material key or custom:<prompt>",
                        lower_state="Material key or custom:<prompt>",
                        tattoo="Tattoo key, \u968f\u673a\u591a\u7eb9\u8eab, \u968f\u673a\u5c11\u7eb9\u8eab, or custom:<prompt>; blank means no tattoo",
                        expression="Expression key, \u968f\u673a, or custom:<prompt>; blank means no expression",
