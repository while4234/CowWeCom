...
def test_weixin_grok_direct_image_uses_recent_image(monkeypatch, tmp_path):
...
def test_weixin_natural_reference_image_routes_to_image_create(monkeypatch, tmp_path):
    _patch_conf(monkeypatch)
    record = _register_recent_image(tmp_path)
